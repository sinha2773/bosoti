        ...
        <div class="row">
            ...
            <div class="col-sm-3">
                <div class="form-group text-right">
                    ...
                    <a target="_blank" href="<?php echo current_url();?>?year=<?php echo isset($_GET['year'])?$_GET['year']:'';?>&print=true" class="btn btn-warning"><i class="fa fa-print" aria-hidden="true"></i> Print</a>
                </div>
            </div>   
        </div>        
    </div>   
...
?>
    <table class="balance_table">
        ...
        <tbody>
            ...
            <!-- <tr class="left-side darkorchid hide">
