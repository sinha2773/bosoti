    ...
    <div class="col-sm-9 desc">
        ...
        <div class="row">
            <div class="col-sm-6">
                <div class="form-group">
                    <label>Basic Salary: </label> <?php echo $data->basic_salary;?>
                </div>
            </div>
            <div class="col-sm-6">
                <div class="form-group">
                    <label>House Rent: </label> <?php echo $data->house_rent;?>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-sm-6">
                <div class="form-group">
                    <label>Medical Allownce:</label> <?php echo $data->medical_allownce;?>
                </div>
            </div>
            <div class="col-sm-6">
                <div class="form-group">
                    <label>Others Allownce:</label> <?php echo $data->other_allownce;?>
                </div>
            </div>
        </div>
    ...
    <div class="form-group">
        <a href="<?php echo base_url($admin_path);?>/get_all/<?php echo $action;?>"><input type="button" class="btn btn-danger pull-left" style="width: 49% " value="Back"></a>
    </div>
<style type="text/css">
