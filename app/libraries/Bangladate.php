	...
	function convertHijri($date,$monthname=false) {
	  ...
	  if(!$monthname){ // return basic
		...
		switch ($m){
		  ...
		  break;
		  case 3:
			$mn = 'রবিউল আওয়াল';//'Rabiulawal';
		  break;
		  case 4:
			$mn = 'রবিউস সানি ';//'Rabiulakhir';
		  break;
		  case 5:
			$mn = 'জমাদিউল আওয়াল';//'Jamadilawal';
		  break;
		  case 6:
			$mn = 'জমাদিউস সানি';//'Jamadilakhir ';
		  break;
		  case 7:
			$mn = 'রজব';//'Rejab';
		  break;
		...
		return($this->bangla_number($d).' '.$mn.', '.$this->bangla_number($y));
	  }
	  }
